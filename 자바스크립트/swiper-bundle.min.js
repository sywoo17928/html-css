 ...
 * Original file: /npm/swiper@12.0.3/swiper.mjs
 *
...
var O = {
  ...
  updateSlides: function () {
    ...
    const s = e.params,
      { wrapperEl: i, slidesEl: r, rtlTranslate: n, wrongRTL: a } = e,
    ...
    for (let i = 0; i < c; i += 1) {
      ...
      if (
        !r ||
        (C && e.grid.updateSlide(i, r, d), "none" !== g(r, "display"))
      ) {
        if (o && "auto" === s.slidesPerView)
          ...
          (I = (x - (s.slidesPerView - 1) * y) / s.slidesPerView),
            s.roundLengths && (I = Math.floor(I)),
    ...
    if (
      ((e.virtualSize = Math.max(e.virtualSize, x) + S),
      n &&
        a &&
      ...
      C && e.grid.updateWrapperSize(I, u),
      !s.centeredSlides)
    ) {
      const t = [];
      for (let i = 0; i < u.length; i += 1) {
        ...
        s.roundLengths && (r = Math.floor(r)),
          u[i] <= e.virtualSize - x && t.push(r);
      }
      (u = t),
        Math.floor(e.virtualSize - x) - Math.floor(u[u.length - 1]) > 1 &&
          u.push(e.virtualSize - x);
    }
    if (o && s.loop) {
      const t = m[0] + y;
    ...
    if ((0 === u.length && (u = [0]), 0 !== y)) {
      ...
      d.filter((e, t) => !(s.cssMode && !s.loop) || t !== d.length - 1).forEach(
        (e) => {
          e.style[t] = `${y}px`;
        }
      );
    ...
    if (r.params.loop)
      if (r.virtual && r.params.virtual.enabled) a += r.virtual.slidesBefore;
        ...
        if (
          ...
          i && d && "auto" !== r.params.slidesPerView && !n && (p = !1),
          p)
        ) {
          const s = d
            ? e < r.activeIndex
...
var _ = {
  ...
  loopFix: function ({
    ...
    let T = f.slidesPerView;
    "auto" === T
      ? (T = l.slidesPerViewDynamic())
      : ((T = Math.ceil(parseFloat(f.slidesPerView, 10))),
        S && T % 2 == 0 && (T += 1));
    const b = f.slidesPerGroupAuto ? T : f.slidesPerGroup;
    let x = S ? Math.max(b, Math.ceil(T / 2)) : b;
    x % b != 0 && (x += b - (x % b)),
      (x += f.loopAdditionalSlides),
      (l.loopedSlides = x);
    const y = l.grid && f.grid && f.grid.rows > 1;
    d.length < T + x || ("cards" === l.params.effect && d.length < T + 2 * x)
      ? h(
    ...
    const E = [],
      M = [],
      P = y ? Math.ceil(d.length / f.grid.rows) : d.length,
      C = n && P - w < T && !S;
    ...
    let O = 0,
      A = 0;
    const z = (y ? d[r].column : r) + (S && void 0 === i ? -T / 2 + 0.5 : 0);
    if (z < x) {
      O = Math.max(x - z, b);
      for (let e = 0; e < x - z; e += 1) {
      ...
      (A = Math.max(z - (P - 2 * x), b)), C && (A = Math.max(A, T - P + w + 1));
      for (let e = 0; e < A; e += 1) {
        const t = e - Math.floor(e / P) * P;
        y
          ? d.forEach((e, s) => {
    ...
    if (
      ...
      "cards" === l.params.effect &&
        d.length < T + 2 * x &&
        (M.includes(r) && M.splice(M.indexOf(r), 1),
      ...
      if (E.length > 0 && k) {
        if (void 0 === e) {
          const e = l.slidesGrid[I],
            t = l.slidesGrid[I + O] - e;
          o
            ? l.setTranslate(l.translate - t)
            : (l.slideTo(I + Math.ceil(O), 0, !1, !0),
              i &&
          ...
          const e = y ? E.length / f.grid.rows : E.length;
        ...
        if (void 0 === e) {
          ...
          const e = y ? M.length / f.grid.rows : M.length;
          l.slideTo(l.activeIndex - e, 0, !1, !0);
        }
    if (
      ((l.allowSlidePrev = c),
...
function N(e) {
  ...
  for (
    ...
    void 0 !== c[e + t]
      ? (m || (h >= c[e] && h < c[e + t])) && ((g = e), (v = c[e + t] - c[e]))
      : (m || h >= c[e]) && ((g = e), (v = c[c.length - 1] - c[c.length - 2]));
  }
  let w = null,
    S = null;
  n.rewind &&
  ...
  if (f > n.longSwipesMs) {
    ...
    "next" === t.swipeDirection &&
      (T >= n.longSwipesRatio
        ? t.slideTo(n.rewind && t.isEnd ? w : g + b)
        : t.slideTo(g)),
    ...
    (r.target === t.navigation.nextEl || r.target === t.navigation.prevEl)
      ? r.target === t.navigation.nextEl
        ? t.slideTo(g + b)
        : t.slideTo(g)
      : ("next" === t.swipeDirection && t.slideTo(null !== w ? w : g + b),
...
class J {
  constructor(...e) {
    ...
    (n.__swiper__ = !0),
      (n.support = x()),
      (n.device = y({ userAgent: s.userAgent })),
      (n.browser = E()),
      (n.eventsListeners = {}),
...
//# sourceMappingURL=/sm/898db8e0f4d2f87b3186ac9d1252d0cd5bc807673f6717e8aeb24828b3cb6edb.map
